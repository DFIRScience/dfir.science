...
[DFIR.Science](https://DFIR.Science) conducts theoretical research, practical development and education, mainly on digital investigation topics. This page contains a collection of more formal work being carried out, often with the [Digital Forensic Investigation Research Laboratory](http://dfire.ucd.ie).
...
For an up to date list of past training sessions and talks, please see my [LinkedIn profile](https://www.linkedin.com/in/jijames). For online lectures see [DFIR.Science courses](https://dfir.science/courses).

### Committees

* Editorial Board, [IEEE Security & Privacy Magazine](https://www.computer.org/product/magazines/security-and-privacy) (Digital Forensics, Since 2020)
* TPC, 2020 [11th EAI International Conference on Digital Forensics & Cyber Crime](http://icdf2c.org)
...
* Reviewer, [DFIR Review](https://dfir.pubpub.org) (Since 2019)
...
* Contributor to [Outstanding](https://outstanding.kr/author/joshua) (Korean)
